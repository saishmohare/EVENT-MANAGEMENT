                ...
                <?php
                    ...
                    $name=$_SESSION['username'];
                        ...
                        else
                        {
                            ...
                            $result="insert into bizcafe(username) values('$name')";               
                            ...
                            if (mysqli_query($conn, $result))
                            {
                               ...
                               /* $row="SELECT id FROM bizcafe WHERE username='$name'";
                                ...
                                $row="Select * from bizcafe where id <= ALL (select id where username='$name')";
